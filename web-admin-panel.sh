...
if test -s /etc/nginx/nginx.conf; then
  ...
  cp -avr quick-free-bootstrap-theme/src html
	green " "
	green "================================="
	blue "       开始配置trojan-web"
	green "================================="
	sleep 2s
  sed -i '/ExecStart/s/trojan web -p 8000/trojan web/g' /etc/systemd/system/trojan-web.service
  sed -i '/ExecStart/s/trojan web/trojan web -p 8000/g' /etc/systemd/system/trojan-web.service
